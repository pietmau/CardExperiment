package com.example.cardexperiment
 ...
 * @see [CardView]
 */
open class MyBpkCardView @JvmOverloads constructor(
  context: Context,
  ...
  /**
   * List of possible border radius for the [MyBpkCardView].
